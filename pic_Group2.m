...
%print('Figure/durg_plan/Group2/PK', '-dpng', '-r600');

%% therapeutic effect
figure('Position', [1100,100,600,400]);
target_1 = load('data/Durg_Plan/Group2/target_1.dat');
target_2 = load('data/Durg_Plan/Group2/target_2.dat');
data = [target_1, target_2];
b = bar(data);
grid on; box on; hold on;

xticks(1:6);
xticklabels({'Plan 1', 'Plan 2', 'Plan 3', 'Plan 4', 'Plan 5', 'Plan 6'});
...
ylabel('\psi');
set(gca,'FontSize',12,'FontName','Arial');
print('Figure/durg_plan/Group2/target', '-dpng', '-r600');
...
writematrix(target_1, 'data/Durg_Plan/Group2/target_1.dat');
writematrix(target_2, 'data/Durg_Plan/Group2/target_2.dat');
...
plan5 = {[0,7], ones(1,2)*D/2};
plan6 = {0,D};

P = {plan1,plan2,plan3,plan4,plan5,plan6};
